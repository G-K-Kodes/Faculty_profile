...
urlpatterns = [
    ...
    path('adminlogin/<int:faculty_id>', views.set_faculty_session, name='set_faculty_session_admin'),  
    ...
    path('<int:faculty_id>/admin_personal', views.admin_personal, name='faculty_personal'),
    path('<int:faculty_id>/admin_academic', views.admin_academic, name='faculty_academic'),
    path('<int:faculty_id>/admin_professional', views.admin_professional, name='faculty_professional'),
    path('<int:faculty_id>/admin_professionalexp', views.admin_profexp, name='faculty_profexp'),
    path('<int:faculty_id>/admin_coursestaught', views.admin_coursestaught, name='faculty_coursestaught'), 
    path('<int:faculty_id>/admin_awards', views.admin_awards, name='faculty_awards'), 
